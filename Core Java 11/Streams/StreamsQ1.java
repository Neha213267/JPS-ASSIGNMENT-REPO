...
public class StreamsQ1 {
    ...
    public static void main(String[] args) {
        ...
        fruits.add( new Fruit("Cheeku",70,50,"Yellow"));
        fruits.add(new Fruit("Peach",80,80,"Red"));
        fruits.add(new Fruit("DragonFruit",110,40,"Yellow"));
        fruits.add( new Fruit("Pear",100,30,"Yellow"));
        fruits.add(new Fruit("Strawberry",60,50,"Green"));
        reverseSort( fruits);
        sort(fruits);
