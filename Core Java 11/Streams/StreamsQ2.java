...
public class StreamsQ2 {
    ...
    public static void main(String[] args) {
        News news1 = new News(1, "Alex", "Kumar", "comment");
        News news2 =new News(2, "Jai", "Singh", "budget");
        News news3 = new News(1, "Vijay", "DeenaNath", "comment");
        News news4 = new News(3, "Jhonny", "Karati", "budget");
        News news5 = new News(1, "Robert", "Downey", "comment");
        News news6 = new News(3, "Venice", "Rome", "budget");
        News news7 = new News(1, "Romeo", "Singh" ,"comment");
