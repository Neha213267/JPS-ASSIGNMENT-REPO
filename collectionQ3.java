...
public class CollectionAssignmentQ3 {
	public static void main(String[] args)
	{
		...
		if(select.equals("a"))
		{
			...
			emp.add(new Employee(101,"Neha","CSE",100000));
            emp.add(new Employee(102,"Astha","CSE",75000));
            emp.add(new Employee(103,"Riya","CSE",40000));
            emp.add(new Employee(104,"Rishi","EEE",80000));
            emp.add(new Employee(105,"Hari","EEE",60000));
            emp.add(new Employee(106,"Ramesh","ECE",85000));
            emp.add(new Employee(107,"Mansi","MECH",45000));
            emp.add(new Employee(108,"Alia","CSE",95000));
            emp.add(new Employee(109,"Sheru","ECE",110000));
            emp.add(new Employee(110,"Teji","CSE",55000));
